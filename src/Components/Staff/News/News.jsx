              ...
              {activeCategory === 'All' && featuredPosts.length > 0 && featuredPosts.slice(0, 1).map(post => (
                <div key={`featured-${post.id}`} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  <div className="px-4 py-3">
                    ...
                    <a href={`/staff/news/${post.id}/`} className="inline-flex items-center text-green-600 font-medium text-sm hover:text-green-700">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
              ...
              <div className="space-y-3">
                {featuredPosts.slice(1, 4).map(post => (
                  <a key={post.id} href={`/staff/news/${post.id}/`} className="flex gap-2 group">
                    {post.thumbnail ? (
