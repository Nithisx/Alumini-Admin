...
const SingleEvents = () => {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        const res = await fetch(`https://0c41dd49b6b06c17e9bfea0690ee4051.serveo.net/api/events/${id}`, {
          headers: {
  ...
  const getImageUrl = (image) => `https://0c41dd49b6b06c17e9bfea0690ee4051.serveo.net/api${image.image}`;
