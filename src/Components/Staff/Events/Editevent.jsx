  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 lg:pb-6">
      <div className="bg-green-600 text-white px-4 py-4 flex items-center gap-3">
        <button onClick={() => navigate(`/staff/event/${id}`)} className="text-white hover:text-green-200">
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="flex justify-end gap-4 mt-6">
          <button type="button" onClick={() => navigate(`/staff/event/${id}`)}
