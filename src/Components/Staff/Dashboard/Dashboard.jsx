...
const HomePage = () => {
  ...
  const stats = [
    ...
    { label: "Events", value: data.upcoming_event, color: "bg-violet-500", path: "/staff/event/", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
      ...
      <div className="max-w-2xl lg:max-w-5xl mx-auto px-4 py-6 space-y-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <button onClick={() => navigate("/staff/albums/")} className="text-sm font-semibold text-emerald-600 hover:text-emerald-700">
              See all
            </button>
          </div>
        ...
        {data.featured_news?.length > 0 && (
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => navigate("/staff/news/")} className="text-sm font-semibold text-emerald-600 hover:text-emerald-700">
                See all
              </button>
            </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <button onClick={() => navigate("/staff/event/")} className="text-sm font-semibold text-emerald-600 hover:text-emerald-700">
              See all
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => navigate("/staff/members/")} className="text-sm font-semibold text-emerald-600 hover:text-emerald-700">
                See all
              </button>
            </div>
