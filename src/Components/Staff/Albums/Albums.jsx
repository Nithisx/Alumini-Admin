  ...
  useEffect(() => {
    ...
    const fetchAlbums = async () => {
      try {
        ...
        const response = await axios.get("https://empire-anything-curriculum-kentucky.trycloudflare.com/albums/", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://empire-anything-curriculum-kentucky.trycloudflare.com/albums/",
        formDataToSend,
        {
          headers: {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {albums.map((album) => (
            ...
            >
              {album.cover_image ? (
                <img
                  src={`https://empire-anything-curriculum-kentucky.trycloudflare.com${album.cover_image}`}
                  alt={album.title}
