  ...
  useEffect(() => {
    ...
    const fetchStudents = async () => {
      try {
        ...
        const response = await axios.get("https://empire-anything-curriculum-kentucky.trycloudflare.com/students/", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://empire-anything-curriculum-kentucky.trycloudflare.com/students/",
        formDataToSend,
        {
          headers: {
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
        {students.map((student) => (
          <div key={student.id} className="bg-white rounded-lg shadow p-4">
            {student.image ? (
              <img
                src={`https://empire-anything-curriculum-kentucky.trycloudflare.com${student.image}`}
                alt={student.name}
