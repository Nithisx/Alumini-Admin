...
import { Search, Send, Phone, Video, MoreVertical, ArrowLeft, Smile, Plus, Users, MessageSquare } from 'lucide-react';
                ...
                <div className="divide-y divide-gray-200">
                  {rooms.map((chat) => (
                    <div
                      ...
                      className={`p-4 hover:bg-gray-50 cursor-pointer transition ${selectedChat?.id === chat.id ? 'bg-green-50 border-r-2 border-green-500' : ''}`}
                    >
                      <div className="flex items-center gap-3">
