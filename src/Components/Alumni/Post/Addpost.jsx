...
const AdminFeed = () => {
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      setPosts(sortedData);
      console.log("Fetched posts:", sortedData[0].images[0].image);
    } catch (err) {
                ...
                <div className="mt-2">
                  {post.images &&
                    ...
                    post.images[0].image && (
                      <>
                        {console.log(
                          `http://134.209.157.195:8000/${post.images[0].image}`
                        )}
                        <img
                          src={`http://134.209.157.195:8000${post.images[0].image}`}
                          alt={`Illustration for ${
                            post.company_name || "job post"
                          }`}
                          className="mt-3 mb-4 w-full max-h-60 rounded-lg object-contain border border-gray-200"
                        />
                      </>
                    )}
