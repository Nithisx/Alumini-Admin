    ...
    <div className="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Manage and explore our community members</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Worked In Filter */}
            <div className="space-y-2">
              <label htmlFor="worked-in-filter" className="block text-sm font-medium text-gray-700">Experience</label>
              <select
                id="worked-in-filter"
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            ...
            {/* Search */}
            <div className="space-y-2">
              <label htmlFor="search-box" className="block text-sm font-medium text-gray-700">Search</label>
                ...
                {members.map(member => (
                  ...
                  >
                    ...
                    <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden relative">
                      <img
                        src={member.profile_photo ? `${BASE_URL}${member.profile_photo}` : getPlaceholderImage(`${member.first_name} ${member.last_name}`)}
                        alt={`${member.first_name} ${member.last_name}`}
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                        onError={(e) => {
                          e.target.onerror = null;
                          e.target.src = getPlaceholderImage(`${member.first_name} ${member.last_name}`);
                        }}
                      />
                      {/* Role Badge */}
