...
const HomePage = observer(() => {
  ...
  const stats = [
    { label: "Members", value: data.total_users, color: "bg-emerald-500", path: `${base}/members/`, icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
    { label: "Upcoming Events", value: data.upcoming_event, color: "bg-violet-500", path: `${base}/event/`, icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
    { label: "Albums", value: data.albums_count, color: "bg-pink-500", path: `${base}/albums/`, icon: "M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z M15 13a3 3 0 11-6 0 3 3 0 016 0z" },
    { label: "News", value: data.new_users, color: "bg-amber-500", path: `${base}/news/`, icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" },
  ];
      ...
      <div className={DASHBOARD_THEME.content}>
        ...
        <section>
          <div className={DASHBOARD_THEME.sectionHeader}>
            ...
            <button onClick={() => navigate(`${base}/albums/`)} className={DASHBOARD_THEME.sectionAction}>
              See all
            </button>
          </div>
        ...
        {data.featured_news?.length > 0 && (
          <section id="news-section">
            <div className={DASHBOARD_THEME.sectionHeader}>
              ...
              <button onClick={() => navigate(`${base}/news/`)} className={DASHBOARD_THEME.sectionAction}>
                See all
              </button>
            </div>
            <div
            ...
            >
              {data.featured_news.map((news, index) => (
                <div
                  ...
                  onClick={() => navigate(`${base}/news/${news.id}/`)}
                  onKeyDown={(e) => {
                    if (e.key === "Enter" || e.key === " ") {
                      e.preventDefault();
                      navigate(`${base}/news/${news.id}/`);
                    }
                  }}
        ...
        <section id="events-section">
          <div className={DASHBOARD_THEME.sectionHeader}>
            ...
            <button onClick={() => navigate(`${base}/event/`)} className={DASHBOARD_THEME.sectionAction}>
              See all
            </button>
          </div>
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-6">
            ...
            <section className="order-2 lg:order-1">
              <div className={DASHBOARD_THEME.sectionHeader}>
                ...
                <button onClick={() => navigate(`${base}/members/`)} className={DASHBOARD_THEME.sectionAction}>
                  See all
                </button>
              </div>
              <div className={DASHBOARD_THEME.memberList}>
                {data.latest_members.map((member) => (
                  <div
                    key={member.id}
                    onClick={() => navigate(`${base}/members/${member.username}/`)}
              ...
              <section className="order-1 lg:order-2">
                ...
                <div className={DASHBOARD_THEME.memberList}>
                  {data.batch_mates.map((mate) => (
                    <div
                      key={mate.id}
                      onClick={() => navigate(`${base}/members/${mate.username}/`)}
                      className={DASHBOARD_THEME.memberRow}
                    >
                      {mate.profile_photo ? (
