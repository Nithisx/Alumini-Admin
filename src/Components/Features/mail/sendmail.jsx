// Sendmail feature disabled — entire component commented out; no longer offered.
// Not imported/used anywhere (see routeManifest.jsx, Breadcrumb.jsx, config/api.js).
...
// import { API_EMAIL_SUGGESTIONS, API_SEND_EMAIL } from "../../../config/api";
// 
// const SendMail = () => {
...
//     try {
//       const response = await axios.get(API_EMAIL_SUGGESTIONS(query), {
//         headers: {
...
// 
//     try {
//       const response = await axios.post(API_SEND_EMAIL, data, {
//         headers: {
//           Authorization: `Token ${localStorage.getItem("Token")}`,
