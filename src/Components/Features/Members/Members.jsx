    ...
    <div className="min-h-screen bg-gray-50 pb-20 lg:pb-6">
        ...
        below={
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 text-sm font-semibold rounded-xl border transition ${showFilters ? "bg-emerald-50 border-emerald-300 text-emerald-700" : "border-gray-200 text-gray-600 hover:bg-gray-50"}`}
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="text-sm text-red-500 hover:text-red-700 font-medium px-2 py-1 rounded-xl hover:bg-red-50 transition"
            >
              Clear
            </button>
            <Can perm="members.export">
              <button
                onClick={() => {
                ...
                className="ml-auto flex items-center gap-1.5 px-3 py-2 text-sm font-semibold bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
      ...
      <div className="max-w-5xl mx-auto px-4 py-4 space-y-4">
        ...
        {loading ? (
          ...
          <MotionList className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
            {members.map((member) => {
              ...
              return (
                <MotionItem
                  ...
                  onClick={() => {
                    if (selectionMode) {
                      ...
                      window.location.href = `${roleBase()}/members/${member.username}`;
                    }
                  }}
                ...
                >
                  ...
                  <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden relative">
                    <img
                      src={member.profile_photo ? `${API_ORIGIN}${member.profile_photo}` : getProfilePlaceholderByGender(member.gender)}
