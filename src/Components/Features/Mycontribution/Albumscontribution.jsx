    ...
    <div className="p-4">
      ...
      <div className="flex items-start gap-2 bg-blue-50 border border-blue-100 rounded-xl px-3 py-2.5 mb-4">
        ...
        <p className="text-xs text-blue-700 leading-relaxed">
          To add or remove images inside an album, open the album from the{" "}
          <a href={`${roleBase()}/albums`} className="font-semibold underline underline-offset-2 hover:text-blue-900">Albums</a>{" "}
          page.
        </p>
      </div>
            ...
            <div className="p-3">
              {editingAlbum === album.id ? (
                ...
                <>
                  ...
                  <div className="flex gap-1.5">
                    <button onClick={() => window.location.href = `${roleBase()}/albums/${album.id}`}
