...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://0c41dd49b6b06c17e9bfea0690ee4051.serveo.net/api/home/");
        if (!response.ok) {
                    ...
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px]">
                        <div className="relative">
                          <img
                            src={`https://0c41dd49b6b06c17e9bfea0690ee4051.serveo.net/api${news.thumbnail}`}
                            alt={news.title}
                        ...
                        <div className="p-12 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white">
                          ...
                          <div className="flex items-center">
                            <img
                              src={`https://0c41dd49b6b06c17e9bfea0690ee4051.serveo.net/api${news.user.profile_photo}`}
                  ...
                  >
                    <div className="relative h-64 overflow-hidden">
                      {event.images && event.images.length > 0 ? (
                        <img
                          src={`https://0c41dd49b6b06c17e9bfea0690ee4051.serveo.net/api${event.images[0].image}`}
                          alt={event.title}
