          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-4xl font-bold text-gray-900 mb-2">{data.total_users.toLocaleString()}</h3>
            ...
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-4xl font-bold text-gray-900 mb-2">{data.new_users.toLocaleString()}</h3>
            ...
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-4xl font-bold text-gray-900 mb-2">{data.chapters.length}</h3>
            ...
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <h3 className="text-4xl font-bold text-gray-900 mb-2">{data.upcoming_events.length}</h3>
        ...
        <section className="py-20 " id="#news-section">
          <div className="container mx-auto px-4">
            ...
            <div className="relative max-w-6xl mx-auto">
                      ...
                      <div className="p-12 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white">
                        <div className="mb-4">
                          <span className="text-blue-600 font-semibold text-sm">
                            {format(new Date(news.published_on), "MMMM d, yyyy")}
                          </span>
                        </div>
                        <h3 className="text-3xl font-bold text-gray-900 mb-6 leading-tight">{news.title}</h3>
                        <p className="text-gray-700 text-lg mb-8 leading-relaxed">{news.content}</p>
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">Alumni Contributor</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <button
                onClick={() =>
                  setNewsSlide((prev) => (prev - 1 + data.featured_news.length) % data.featured_news.length)
                }
              ...
              <button
                onClick={() => setNewsSlide((prev) => (prev + 1) % data.featured_news.length)}
      ...
      {/* Latest Members Section */}
        <section className="py-20 ">
          ...
          {data.latest_members.slice(0, 6).map((member) => (
            ...
            <p className="text-black font-semibold mb-2">{member.current_work || "Alumni"}</p>
            <p className="text-black mb-4">
              {member.city}, {member.state}
            </p>
            <p className="text-sm text-black mb-6">Class of {member.passed_out_year}</p>
        ...
        {/* Chapters Section */}
          ...
          <div className="flex items-center">
            ...
            <span className="text-green-700 font-semibold">{chapter.member_count} Members</span>
          </div>
          <span className="text-green-700 text-sm font-medium bg-green-100 px-2 py-1 rounded-full">Active</span>
            </div>
        ...
        <section className="py-20  text-green-900 relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Ready to Connect?</h2>
          <p className="text-xl md:text-2xl mb-12 text-green-700 leading-relaxed">
            Join thousands of alumni who are already part of our thriving community. Network, learn, and grow
            together.
          </p>
