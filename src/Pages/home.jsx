      ...
      <div className="flex-grow flex items-center justify-center bg-gradient-to-b from-gray-50 to-blue-50">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 mx-auto max-w-2xl">
            Connecting graduates, sharing opportunities, and building a stronger
            community.
          </p>
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Find and connect with alumni from your batch, department or
                across the years.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Stay updated with alumni events, reunions and networking
                opportunities.
              </p>
            </div>{" "}
          </div>
          ...
          <div
            id="contact"
            className="mt-24 bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto"
          >
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Connecting graduates and building opportunities together.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
            <p>
              © {new Date().getFullYear()} Karpagam Academy of Higher Education.
              All rights reserved.
            </p>
          </div>
        </div>
