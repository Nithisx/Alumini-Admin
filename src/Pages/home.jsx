...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <HomeNavbar />
        {/* Hero section */}
      <div className="flex-grow flex items-center justify-center bg-gradient-to-b from-gray-50 to-blue-50">
        <div className="container mx-auto px-4 py-16 text-center">
          <img src={kahelogo} alt="Alumni Logo" className="mx-auto w-32 h-32 mb-6" />
          <h1 className="text-4xl font-bold text-blue-600 mb-4">Alumni Network</h1>
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Find and connect with alumni from your batch, department or across the years.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Stay updated with alumni events, reunions and networking opportunities.</p>
            </div>          </div>
          
          {/* Contact section */}
          <div id="contact" className="mt-24 bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
            ...
            <form className="space-y-4">
              ...
              <button type="button" className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors">
                Send Message
              </button>
            </form>
          </div>
