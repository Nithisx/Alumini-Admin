        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="flex mb-8 overflow-x-auto pb-2">
            <button
              ...
              className={`px-5 py-2 mx-1 rounded-full font-medium ${
            ...
            <button
              onClick={() => {
                window.location.hash = "vision-mission";
            ...
            <button
              onClick={() => {
                window.location.hash = "RegistrationCertificate";
                setActiveSection("RegistrationCertificate");
              }}
              className={`px-5 py-2 mx-1 rounded-full font-medium ${
